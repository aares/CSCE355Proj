...
def main():
    ...
    for i in range(strLen):                         #iterate thru inputString length
        ...
        for j in range(len(alphabet)):              #iterate thru alphabet length
            rowList.append(str(0))                  #populate blank row [0,0,,,,0], where len rowList = alphabet
        for j in range(len(alphabet)):              #iterate thru alphabet tranTable[j]
            ...
            if (i == strLen):
                rowList[j] = i
        columnList.append(rowList)                  #push row into tranTable until at the end of inputString
